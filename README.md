...
**data/** Sample customer data provided for demonstration purposes.<br>
**database/** Database configuration, schemas and queries.<br>
**docs/** Documentation files.<br>
**inputs/** Input files for ETL Pipeline.<br>
**scripts/** Supporting scripts and utilities.<br>
**etl_pipeline_testing.py** Script for testing the full ETL workflow.<br>
